...
export default function Page() {
  const cards = [
    ...
    },
    {
      ...
      title: "რას იპოვით აქ?",
      description:
        "მოსწავლეებს ვაძლევთ შესაძლებლობას, ქიმიის სამყარო შეისწავლონ მრავალფეროვანი სასწავლო რესურსების მეშვეობით. ჩვენი მისიაა, მეცნიერება გავხადოთ ყველასთვის მარტივი, გასაგები და ხელმისაწვდომი, ხელი შევუწყოთ მოსწავლეთა მოტივაციის ამაᲦლებასა და კრიტიკული აზროვნების განვითარებას.",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
        <section className="space-y-6 mt-10">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-wide">
            ...
            <span className="text-cyan-400">ტონი</span>
          </h1>
